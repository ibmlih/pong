...
function love.load()
    ...
    player1 = Paddle(10, VIRTUAL_HEIGHT / 2, 5, 20, 'vertical')

    -- Up and Down Paddle
    player2 = Paddle(VIRTUAL_WIDTH / 2, 10, 20, 5, 'horizontal')
...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        if ball:collides(player1, player1.x, player1.y) then
        ...
        if ball:collides(player1, VIRTUAL_WIDTH - 15, player1.y) then
            ball.dx = -ball.dx * 1.03
            ball.x = VIRTUAL_WIDTH - 15 - 4
        ...
        if ball:collides(player2, player2.x, player2.y) then
        ...
        if ball:collides(player2, player2.x, VIRTUAL_HEIGHT - 15) then
            ball.dy = -ball.dy * 1.03
            ball.y = VIRTUAL_HEIGHT - 15 - 4
