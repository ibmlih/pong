...
function Paddle:render()
    local newWidth = VIRTUAL_WIDTH - 10 - 5
    local newHeight = VIRTUAL_HEIGHT - 10 - 5

    if self.type == 'vertical' then
        love.graphics.rectangle('fill', self.x, self.y, self.width, self.height)
        love.graphics.rectangle('fill', newWidth, self.y, self.width, self.height)
    else
        love.graphics.rectangle('fill', self.x, self.y, self.width, self.height)
        love.graphics.rectangle('fill', self.x, newHeight, self.width, self.height)
    end
end
